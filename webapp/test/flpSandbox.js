		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product",
									"targetURL": "#sapcomproduct-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomproduct-display": {
								"semanticObject": "sapcomproduct",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.product",
									"url": sap.ui.require.toUrl("sap/com/product")
								}
							}
						}
					}
